...
function helpText() {
  return [
    ...
    '/qa_draft - generates a QA checklist and commit/push readiness review only. Does not create the review.',
...
function nextText() {
  return [
    ...
    'Add a /issue_draft command to turn a request into a GitHub issue-style brief, still read-only.',
    '',
