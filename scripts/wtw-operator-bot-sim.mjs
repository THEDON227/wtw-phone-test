...
function statusText() {
  ...
  return [
    ...
    'Telegram local wrapper is working. Commit the Telegram wrapper safely, then switch back to outreach/business execution. Public site stays frozen unless fixing a real bug.',
    '',
